...
<a class="pb-set-card" href="2024_sep_2_s1q1/">
<div class="pb-set-card-label">Section 1 · Question 1</div>
<h3>Check If a Number Divides Two Others</h3>
<p>Return True if <code>c</code> divides both <code>a</code> and <code>b</code>. Covers the modulo divisibility test, short-circuit <code>and</code>, and <code>all()</code> for extensibility.</p>
<span class="pb-badge pb-badge-done">Solved</span>
</a>

<a class="pb-set-card" href="2024_sep_2_s1q2/">
<div class="pb-set-card-label">Section 1 · Question 2</div>
<h3>Check String Rotation</h3>
<p>Return True if one string is a rotation of another. Covers the classic <code>str2 in str1+str1</code> trick and why the length check is mandatory.</p>
<span class="pb-badge pb-badge-done">Solved</span>
</a>

<a class="pb-set-card" href="2024_sep_2_s1q3/">
<div class="pb-set-card-label">Section 1 · Question 3</div>
<h3>Find Missing Number in a Range</h3>
<p>Find the single missing number from a list of 1 to n. Covers set difference, the sum formula, and why set difference handles duplicates correctly.</p>
<span class="pb-badge pb-badge-done">Solved</span>
</a>
